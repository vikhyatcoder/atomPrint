...
const portfolioItems = [
  {
    ...
    description:
      "A beautifully detailed 3D printed Ganesha figurine in vibrant blue PLA. Perfect as a decorative piece or religious symbol.",
    client: "Local Temple",
    material: "PLA, Blue",
    printTime: "8 hours",
  },
  ...
  },
  {
    ...
    description: "A detailed miniature boat model, perfect for educational purposes or as a decorative item.",
    client: "Maritime Museum",
    material: "White PLA",
    printTime: "6 hours",
  },
  {
    ...
    description: "A flexible, articulated dinosaur toy with movable joints. Great for children's educational play.",
    client: "Local School",
  ...
  },
  {
    ...
    description: "A detailed spider model for biology education, featuring accurate anatomical details.",
    client: "Biology Department",
    material: "White PLA",
    printTime: "3 hours",
  },
  {
