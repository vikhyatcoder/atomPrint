...
const portfolioItems = [
  ...
  },
  {
    ...
    description: "Detailed model of a boat suitable for decoration and gifting purposes and also available for architectural purposes.",
    client: "Suman Bhati ",
    material: "White PLA",
    printTime: "6 hours",
  },
  {
    ...
    description: "A cheerful model of a dino, expressing about the emotion of Joy optimal for giftings and décor purposes",
  ...
  },
  {
    ...
    description: "Model of a spider describing about the texture and the physical features of it best for educational purposes and demonstration",
    client: "Jatin Bansal",
    material: "White PLA",
    printTime: "3 hours",
  },
