      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cookie-policy" className="text-gray-400 hover:text-gray-200 transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500">
          ...
          <div className="mt-2 md:mt-0 flex flex-wrap justify-center gap-4">
            <Link href="/privacy-policy" className="text-gray-500 hover:text-gray-400 transition-colors text-sm">
              Privacy Policy
            </Link>
            <Link href="/cookie-policy" className="text-gray-500 hover:text-gray-400 transition-colors text-sm">
              Cookie Policy
            </Link>
