...
const services = [
  ...
  },
  {
    ...
    description: "High-quality, durable printing techniques are used for the production of components for industrial replacements and applications",
    icon: Factory,
...
"Custom finishers",
  ...
  },
  {
    ...
    description: "Detailed art prints Collaborations with artists Limited edition prints option available Custom finishers",
    icon: Cog,
